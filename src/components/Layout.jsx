...
export default function Layout({ title, subtitle, children }) {
  ...
  const [isBannerHidden, setIsBannerHidden] = useState(localStorage.getItem('metrics_trialBannerHidden') === 'true');
          ...
          {!forceShow && (
            <button 
              onClick={(e) => {
                ...
                localStorage.setItem('metrics_trialBannerHidden', 'true');
              }}
